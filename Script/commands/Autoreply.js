...
module.exports.handleEvent = async function ({ api, event }) {
  ...
  const responses = {
    "miss you": "অরেক বেডারে Miss না করে xan মেয়ে হলে বস সুহান রে হাঙ্গা করো😶👻😘",
    "miss u too": "হুম আমি ও তোমাকে Miss করি... কিন্তু সুহান বস বেশি করে 😏💖",
    ...
    "ami Suhan": "হ্যা বস কেমন আছেন..?☺️",
    "bot er baccha": "আমার বাচ্চা তো তোমার গার্লফ্রেন্ডের পেটে..!!🌚⛏️",
    "tor nam ki": "MY NAME IS ─꯭─⃝‌‌SUHAN_BABY_OKY💖",
    ...
    "kire bot": "হ্যাঁ, বস কেমন আছেন আপনার ওই খানে উম্মাহ 😘😽🙈",
    ...
    "lovely": "Love করলে সরাসরি সাহু বস কে বল জানু 😻🔥"
  };
